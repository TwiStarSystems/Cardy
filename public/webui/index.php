...
$routes = [
    'GET'  => [
        ...
        '/admin/backup'                   => [AdminController::class,   'backupPage'],
        '/admin/invites'                  => [AdminController::class,   'invites'],
        '/admin/mail'                     => [AdminController::class,   'mailSettings'],
    ...
    'POST' => [
        ...
        '/forgot-password'                => [AuthController::class,    'processForgotPassword'],
        '/reset-password'                 => [AuthController::class,    'processResetPassword'],
        '/signup'                         => [AuthController::class,    'processSignup'],
        ...
        '/contacts/addressbooks/{id}/share'                   => [ContactsController::class, 'shareAddressBookAction'],
        '/contacts/addressbooks/{id}/shares/{username}/delete' => [ContactsController::class, 'unshareAddressBookAction'],
        ...
        '/calendar/calendars/{id}/share'                   => [CalendarController::class, 'shareCalendarAction'],
        '/calendar/calendars/{id}/shares/{username}/delete' => [CalendarController::class, 'unshareCalendarAction'],
        ...
        '/admin/backup/download'          => [AdminController::class,   'backupDownload'],
        '/admin/invites'                  => [AdminController::class,   'createInvite'],
        '/admin/invites/{id}/delete'      => [AdminController::class,   'deleteInvite'],
        '/calendar/{id}/move'             => [CalendarController::class,'moveEvent'],
        '/admin/mail'                     => [AdminController::class,   'updateMailSettings'],
        '/admin/mail/test'                => [AdminController::class,   'testMail'],
